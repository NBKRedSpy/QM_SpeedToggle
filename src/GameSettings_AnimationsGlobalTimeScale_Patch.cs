...
namespace QM_SpeedToggle
{
    ...
    /// </summary>
    [HarmonyPatch(typeof(GameSettings), nameof(GameSettings.AnimationsGlobalTimeScale))]
    internal static class GameSettings_AnimationsGlobalTimeScale_Patch
    {
        public static bool Prefix(ref float __result)
        {
            if (!Plugin.ToggleSpeedUtil.IsEnbledAndEngaged) return true;

            __result = Plugin.ToggleSpeedUtil.Multiplier;
